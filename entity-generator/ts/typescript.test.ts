import { NestedTypeBuilder, NestedTypeFactory } from '../../src-generated/go/nested_type'
import { SimpleType, SimpleTypeFactory } from '../../src-generated/go/simple_type'
it('SimpleType-Error', () => {
...
it(`NestedType-Builder Object-JSON-Object`, () => {
    ...
    }).unwrap()).toEqual(builder.Get().unwrap())
    ...
    expect(fromJson.Get().unwrap().arrayarrayFlatSchema).toEqual([[[[{Test: "Test42", opt_Test: undefined}], [{Test: "43", opt_Test: undefined}]]]])
})